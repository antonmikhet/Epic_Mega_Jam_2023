...
// Note: These are just copied from ModelingTaskTypes.h in MeshModelingToolset plugin
// It would be nice if they were exposed in the engine for anyone to use
